...
wd <- paste0('/media/jorge/ATTR_1_mac/BIOGUNE_Exosomas_smallRNAseq/UNIZAR-04/Analysis_use_PCRdup/', cond_test, '_Vs_', cond_ref)
setwd(wd)
# setwd('/media/jorge/ATTR_1_mac/BIOGUNE_Exosomas_smallRNAseq/UNIZAR-04/Analysis_use_PCRdup/g4_Vs_g2')
# setwd('/media/jorge/ATTR_1_mac/BIOGUNE_Exosomas_smallRNAseq/UNIZAR-04/Analysis_use_PCRdup/g1_Vs_g2')
# setwd('/media/jorge/ATTR_1_mac/BIOGUNE_Exosomas_smallRNAseq/UNIZAR-04/Analysis_use_PCRdup/g1_Vs_g3')
# setwd('/media/jorge/ATTR_1_mac/BIOGUNE_Exosomas_smallRNAseq/UNIZAR-04/Analysis_use_PCRdup/g1_Vs_g4')
# setwd('/media/jorge/ATTR_1_mac/BIOGUNE_Exosomas_smallRNAseq/UNIZAR-04/Analysis_use_PCRdup/g2_Vs_g3')
# setwd('/media/jorge/ATTR_1_mac/BIOGUNE_Exosomas_smallRNAseq/UNIZAR-04/Analysis_use_PCRdup/g4_Vs_g3')
# setwd('/media/jorge/ATTR_1_mac/BIOGUNE_Exosomas_smallRNAseq/UNIZAR-04/Analysis_use_PCRdup/g14_Vs_g23')
# setwd('/media/jorge/ATTR_1_mac/BIOGUNE_Exosomas_smallRNAseq/UNIZAR-04/Analysis_use_PCRdup/g124_Vs_g3')
...
pdf_file <- paste0("/home/jorge/Escritorio/RNA_seq_luca/exosomes/results/LFC", LFC, "/", cond_test, cond_ref, "/", "hist_rowSums_log10.pdf")
...
# (in many cases genes with 0 counts in all samples).
...
# There is one important thing to note, DESeq2 does not check sample names, it expects that the column names in the counts matrix
# we created correspond exactly to the row names we specify in the experimental design

# construct a mapping of the meta data for our experiment
...
# for each column, and (3) the biological conditions we wish to compare.
...
deGeneResult = resLFC
pdf_file <- paste0("/home/jorge/Escritorio/RNA_seq_luca/exosomes/results/LFC", LFC, "/", cond_test, cond_ref, "/", "plotMA_raw.pdf")
pdf(pdf_file, width = 7, height = 5)
plotMA(res, ylim=c(-5,5), main="Raw log2FC")
dev.off()
pdf_file <- paste0("/home/jorge/Escritorio/RNA_seq_luca/exosomes/results/LFC", LFC, "/", cond_test, cond_ref, "/", "plotMA_shrinked.pdf")
pdf(pdf_file, width = 7, height = 5)
plotMA(deGeneResult, ylim=c(-5,5), main="Shrinked log2FC")
dev.off()

pdf_file <- paste0("/home/jorge/Escritorio/RNA_seq_luca/exosomes/results/LFC", LFC, "/", cond_test, cond_ref, "/", "raw_vs_shrinked")
pdf(pdf_file, width = 7, height = 5)
plot(
  res$log2FoldChange,
...
file_name <- paste0("/home/jorge/Escritorio/RNA_seq_luca/exosomes/results/LFC", LFC, "/", cond_test, cond_ref, "/", cond_test, "_vs_", cond_ref, "_ashr_shr.xlsx")
library(openxlsx)
write.xlsx(miRNAs_sig, file = file_name, rowNames = TRUE)
file_name <- paste0("/home/jorge/Escritorio/RNA_seq_luca/exosomes/results/LFC", LFC, "/", cond_test, cond_ref, "/", cond_test, "_vs_", cond_ref, "_ashr_shr_all_DE_genes.xlsx")
...
file_name <- paste0("/home/jorge/Escritorio/RNA_seq_luca/exosomes/results/LFC", LFC, "/", cond_test, cond_ref, "/", cond_test, "_vs_", cond_ref, "_ashr_shr_lfc_filtered.xlsx")
...
file_name <- paste0("/home/jorge/Escritorio/RNA_seq_luca/exosomes/results/LFC", LFC, "/", cond_test, cond_ref, "/", cond_test, "_vs_", cond_ref, "_ashr_shr_top50.xlsx")
...
directory <- paste0("/home/jorge/Escritorio/RNA_seq_luca/exosomes/results/LFC", LFC, "/", cond_test, cond_ref, "/")
setwd(directory)
library(readxl)

file_name_ashr <- paste0("/home/jorge/Escritorio/RNA_seq_luca/exosomes/results/LFC", LFC, "/", cond_test, cond_ref, "/", cond_test, "_vs_", cond_ref, "_ashr_shr_top50.xlsx")
file_name_no_shr <- paste0("/home/jorge/Escritorio/RNA_seq_luca/exosomes/results/LFC", LFC, "/", cond_test, cond_ref, "/", cond_test, "_vs_", cond_ref, "_no_shr_top50.xlsx")
...
shared_top_DE_genes <- paste0("/home/jorge/Escritorio/RNA_seq_luca/exosomes/results/LFC", LFC, "/", cond_test, cond_ref, "/", cond_test, "_vs_", cond_ref, "_shared_top_DE_genes.xlsx")
...
pdf_file <- paste0("/home/jorge/Escritorio/RNA_seq_luca/exosomes/results/LFC", LFC, "/", cond_test, cond_ref, "/", "distance_sample_heatmap")
pdf(pdf_file, width = 7, height = 5)
...
pdf_file <- paste0("/home/jorge/Escritorio/RNA_seq_luca/exosomes/results/LFC", LFC, "/", cond_test, cond_ref, "/", "similarity_sample_heatmap")
pdf(pdf_file, width = 7, height = 5)
...
file_name_all_DE_genes <- file_name <- paste0("/home/jorge/Escritorio/RNA_seq_luca/exosomes/results/LFC", LFC, "/", cond_test, cond_ref, "/", cond_test, "_vs_", cond_ref, "_ashr_shr_all_DE_genes.xlsx")
...
pdf_file <- paste0("/home/jorge/Escritorio/RNA_seq_luca/exosomes/results/LFC", LFC, "/", cond_test, cond_ref, "/", "DE_distribution")
pdf(pdf_file, width = 7, height = 5)
...
pdf_file <- paste0("/home/jorge/Escritorio/RNA_seq_luca/exosomes/results/LFC", LFC, "/", cond_test, cond_ref, "/", "DEG_volcano_plot")
pdf(pdf_file, width = 7, height = 5)
...
pdf_file <- paste0("/home/jorge/Escritorio/RNA_seq_luca/exosomes/results/LFC", LFC, "/", cond_test, cond_ref, "/", "BP_miRNA_targets")
pdf(pdf_file, width = 7, height = 9)
dotplot(ego_bp_simplified, showCategory = 15) +
  ggtitle("GO Biological Process – miRNA targets")
dev.off()

pdf_file <- paste0("/home/jorge/Escritorio/RNA_seq_luca/exosomes/results/LFC", LFC, "/", cond_test, cond_ref, "/", "MF_miRNA_targets")
pdf(pdf_file, width = 7, height = 9)
dotplot(ego_mf_simplified, showCategory = 15) +
  ggtitle("GO Molecular Function – miRNA targets")
dev.off()

pdf_file <- paste0("/home/jorge/Escritorio/RNA_seq_luca/exosomes/results/LFC", LFC, "/", cond_test, cond_ref, "/", "CC_miRNA_targets")
pdf(pdf_file, width = 7, height = 9)
dotplot(ego_cc_simplified, showCategory = 15) +
  ggtitle("GO Cellular Component – miRNA targets")
dev.off()

pdf_file <- paste0("/home/jorge/Escritorio/RNA_seq_luca/exosomes/results/LFC", LFC, "/", cond_test, cond_ref, "/", "BP_miRNA_targets_barplot")
pdf(pdf_file, width = 7, height = 9)
barplot(ego_bp_simplified, showCategory = 15)
dev.off()

pdf_file <- paste0("/home/jorge/Escritorio/RNA_seq_luca/exosomes/results/LFC", LFC, "/", cond_test, cond_ref, "/", "MF_miRNA_targets_barplot")
pdf(pdf_file, width = 7, height = 9)
barplot(ego_mf_simplified, showCategory = 15)
dev.off()

pdf_file <- paste0("/home/jorge/Escritorio/RNA_seq_luca/exosomes/results/LFC", LFC, "/", cond_test, cond_ref, "/", "CC_miRNA_targets_barplot")
pdf(pdf_file, width = 7, height = 9)
...
pdf_file <- paste0("/home/jorge/Escritorio/RNA_seq_luca/exosomes/results/LFC", LFC, "/", cond_test, cond_ref, "/", "BP_miRNA_targets_up")
pdf(pdf_file, width = 7, height = 9)
dotplot(ego_bp_up_simplified, showCategory = 15) +
  ggtitle("GO Biological Process – miRNA targets")
dev.off()

pdf_file <- paste0("/home/jorge/Escritorio/RNA_seq_luca/exosomes/results/LFC", LFC, "/", cond_test, cond_ref, "/", "MF_miRNA_targets_up")
pdf(pdf_file, width = 7, height = 9)
dotplot(ego_mf_up_simplified, showCategory = 15) +
  ggtitle("GO Molecular Function – miRNA targets")
dev.off()

pdf_file <- paste0("/home/jorge/Escritorio/RNA_seq_luca/exosomes/results/LFC", LFC, "/", cond_test, cond_ref, "/", "CC_miRNA_targets_up")
pdf(pdf_file, width = 7, height = 9)
dotplot(ego_cc_up_simplified, showCategory = 15) +
  ggtitle("GO Cellular Component – miRNA targets")
dev.off()

pdf_file <- paste0("/home/jorge/Escritorio/RNA_seq_luca/exosomes/results/LFC", LFC, "/", cond_test, cond_ref, "/", "BP_miRNA_targets_barplot_up")
pdf(pdf_file, width = 7, height = 9)
barplot(ego_bp_up_simplified, showCategory = 15)
dev.off()

pdf_file <- paste0("/home/jorge/Escritorio/RNA_seq_luca/exosomes/results/LFC", LFC, "/", cond_test, cond_ref, "/", "MF_miRNA_targets_barplot_up")
pdf(pdf_file, width = 7, height = 9)
barplot(ego_mf_up_simplified, showCategory = 15)
dev.off()

pdf_file <- paste0("/home/jorge/Escritorio/RNA_seq_luca/exosomes/results/LFC", LFC, "/", cond_test, cond_ref, "/", "CC_miRNA_targets_barplot_up")
pdf(pdf_file, width = 7, height = 9)
...
pdf_file <- paste0("/home/jorge/Escritorio/RNA_seq_luca/exosomes/results/LFC", LFC, "/", cond_test, cond_ref, "/", "BP_miRNA_targets_down")
pdf(pdf_file, width = 7, height = 9)
dotplot(ego_bp_down, showCategory = 15) +
  ggtitle("GO Biological Process – miRNA targets")
dev.off()

pdf_file <- paste0("/home/jorge/Escritorio/RNA_seq_luca/exosomes/results/LFC", LFC, "/", cond_test, cond_ref, "/", "MF_miRNA_targets_down")
pdf(pdf_file, width = 7, height = 9)
dotplot(ego_mf_down, showCategory = 15) +
  ggtitle("GO Molecular Function – miRNA targets")
dev.off()

pdf_file <- paste0("/home/jorge/Escritorio/RNA_seq_luca/exosomes/results/LFC", LFC, "/", cond_test, cond_ref, "/", "CC_miRNA_targets_down")
pdf(pdf_file, width = 7, height = 9)
dotplot(ego_cc_down, showCategory = 15) +
  ggtitle("GO Cellular Component – miRNA targets")
dev.off()

pdf_file <- paste0("/home/jorge/Escritorio/RNA_seq_luca/exosomes/results/LFC", LFC, "/", cond_test, cond_ref, "/", "BP_miRNA_targets_barplot_down")
pdf(pdf_file, width = 7, height = 9)
barplot(ego_bp_down, showCategory = 15)
dev.off()

pdf_file <- paste0("/home/jorge/Escritorio/RNA_seq_luca/exosomes/results/LFC", LFC, "/", cond_test, cond_ref, "/", "MF_miRNA_targets_barplot_down")
pdf(pdf_file, width = 7, height = 9)
barplot(ego_mf_down, showCategory = 15)
dev.off()

pdf_file <- paste0("/home/jorge/Escritorio/RNA_seq_luca/exosomes/results/LFC", LFC, "/", cond_test, cond_ref, "/", "CC_miRNA_targets_barplot_down")
pdf(pdf_file, width = 7, height = 9)
...
pdf_file <- paste0("/home/jorge/Escritorio/RNA_seq_luca/exosomes/results/LFC", LFC, "/", cond_test, cond_ref, "/", "kegg_up")
pdf(pdf_file, width = 7, height = 5)
dotplot(ekegg_up)
dev.off()

pdf_file <- paste0("/home/jorge/Escritorio/RNA_seq_luca/exosomes/results/LFC", LFC, "/", cond_test, cond_ref, "/", "kegg_up_barplot")
pdf(pdf_file, width = 7, height = 5)
barplot(ekegg_up)
dev.off()
...
pdf_file <- paste0("/home/jorge/Escritorio/RNA_seq_luca/exosomes/results/LFC", LFC, "/", cond_test, cond_ref, "/", "kegg_down")
pdf(pdf_file, width = 7, height = 5)
dotplot(ekegg_down)
dev.off()

pdf_file <- paste0("/home/jorge/Escritorio/RNA_seq_luca/exosomes/results/LFC", LFC, "/", cond_test, cond_ref, "/", "kegg_down_barplot")
pdf(pdf_file, width = 7, height = 5)
barplot(ekegg_down)
dev.off()
